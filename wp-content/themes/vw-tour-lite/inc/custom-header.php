 ...
 * @uses vw_tour_lite_admin_header_style()
 * @uses vw_tour_lite_admin_header_image()
*/
...
function vw_tour_lite_custom_header_setup() {
	...
	add_theme_support( 'custom-header', apply_filters( 'vw_tour_lite_custom_header_args', array(
		...
		'admin-head-callback'    => 'vw_tour_lite_admin_header_style',
...
if ( ! function_exists( 'vw_tour_lite_admin_header_style' ) ) :
...
function vw_tour_lite_admin_header_style() {?>
	<style type="text/css">
		.appearance_page_custom-header #headimg { border: none; }
	</style><?php
}
endif; // vw_tour_lite_admin_header_style
