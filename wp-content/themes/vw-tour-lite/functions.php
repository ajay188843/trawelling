...
define('vw_tour_lite_CREDIT','https://www.vwthemes.com/product/vw-tour-theme/','vw-tour-lite');
define('vw_tour_lite_SUBCREDIT','https://www.vwthemes.com','vw-tour-lite');

if ( ! function_exists( 'vw_tour_lite_credit' ) ) {
	function vw_tour_lite_credit(){
			return "<a href=".esc_url(vw_tour_lite_CREDIT)." target='_blank' rel='nofollow'>Tour WordPress Theme</a> By <a href=".esc_url(vw_tour_lite_SUBCREDIT)." target='_blank' rel='nofollow'>VWThemes</a>";
	}
}
